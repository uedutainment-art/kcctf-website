...
export default function RefundPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  const sectionsKo: LegalSection[] = [
    ...
    },
    {
      heading: '환불 방법',
      paragraphs: [
        '환불은 입금하신 계좌로 계좌이체를 통해 진행됩니다. 환불을 원하시면 info@kcctf.org 로 신청자 성함과 함께 요청해 주세요. 확인 후 영업일 기준 7~14일 이내에 처리됩니다.',
  ...
  const sectionsEn: LegalSection[] = [
    ...
    },
    {
      ...
      paragraphs: [
        'Refunds are issued by bank transfer to the account used for payment. To request a refund, email info@kcctf.org with the registrant’s name. Approved refunds are processed within 7–14 business days.',
