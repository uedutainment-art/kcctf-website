          ...
          <div className="flex h-[72px] items-center justify-between gap-4">
            ...
            <div className="hidden lg:flex items-center gap-4">
              <Link
                ...
                className="px-3 py-4 font-en-body font-bold text-[15px] leading-none tracking-[0.12em] uppercase text-ink transition-colors duration-200 hover:text-burgundy"
              >
                {t('languageSwitch')}
              </Link>
              {registrationOpen && (
            ...
            <div className="flex lg:hidden items-center gap-3">
              <Link
                ...
                locale={altLocale}
                aria-label={locale === 'ko' ? 'English' : '한국어'}
                className="px-2 py-3 font-en-body font-bold text-[13.5px] leading-none tracking-[0.08em] uppercase text-ink transition-colors duration-200 hover:text-burgundy"
              >
                {t('languageSwitch')}
              </Link>
              {registrationOpen && (
